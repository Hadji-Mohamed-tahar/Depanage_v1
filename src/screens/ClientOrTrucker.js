    ...
    >
      ...
      >
        ...
        <View style={{width : "100%"}} className=" w-full flex-row mt-8 space-x-6">
          ...
          <TouchableOpacity style={[styles.shadow , {width : "43%"}]} className="h-20 bg-white rounded-md items-center justify-center" onPress={()=>navigation.navigate("LoginTrucker2")}>
